```json lw-blog-meta
{"title":"Go Modules 快速入门（第三方库编写者）","date":"2020-11-15","brev":"已经很熟悉作为最下游的调包侠如何使用 Go Modules ，今天来研究一下作为上游的第三方库的编写者应该如何使用这套体系来创建规范的库供他人使用。","tags":["Golang"],"path":"blog/2020/201115-GoModules教程.md"}
```
