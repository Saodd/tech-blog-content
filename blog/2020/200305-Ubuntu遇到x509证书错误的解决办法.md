```json lw-blog-meta
{"title":"Ubuntu遇到x509证书错误的解决办法","date":"2020-03-05","brev":"在alpine中运行正常的Golang程序，在ubuntu镜像中却遇到了 x509: certificate signed by unknown authority 问题。","tags":["OS"],"path":"blog/2020/200305-Ubuntu遇到x509证书错误的解决办法.md"}
```
