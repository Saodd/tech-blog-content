...
![Figure 16.2](https://saodd.github.io/tech-blog-pic/2019/2019-08-14-Fig-16-2.png)

## 16.2 我们访问的是哪个碎片

一种常见的方法是，我们显式地将地址的一部分位数来代表碎片编号，剩下的用来表示`偏离值offset`（即片内地址）.比如在上面的例子中，我们有3个碎片，所以需要前面两位来表示碎片编号：

![Figure 16.3](https://saodd.github.io/tech-blog-pic/2019/2019-08-14-Fig-16-3.png)
...
![Figure 16.4](https://saodd.github.io/tech-blog-pic/2019/2019-08-14-Fig-16-4.png)

## 16.4 允许共享

为了节省内存，有时需要在不同的地址空间之间共享内存，比如Code碎片就肯定可以。于是增加一个`保护位protection bits`：

![Figure 16.5](https://saodd.github.io/tech-blog-pic/2019/2019-08-14-Fig-16-5.png)
