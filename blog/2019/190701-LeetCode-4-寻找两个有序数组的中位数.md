...
![容量翻倍法示意图](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-07-01-Algo-DoubleList.png)
...
用二分法循环，只要max(左边)<=min(右边)并且len(左边)==len(右边)就满足了条件，跳出循环。（注意，他们都是偶数长度的数组）
    ...
    ![条件示意图](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-07-01-Algo-Conditions.png)
