```json lw-blog-meta
{"title":"算法: 红黑树","date":"2019-08-30","brev":"二叉查找树与它的升级版，红黑树。","tags":["算法与数据结构"],"path":"blog/2019/190830-红黑树.md"}
```
...
![BST](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-BST.png)
...
![Shadow](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-Shadow.png)

那么，删除某个结点的操作，其实就是将该结点相邻的结点替换该结点的位置就好了：

![Delete](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-Delete.png)
...
![23Tree](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-23Tree.png)

这种算法可以实现树的完美平衡（因为底层会向上层进位）。下图展示了2-3树在同一个输入集合，在随机顺序和升序顺序的输入情况下，都能保持平衡：

![23TreeInsert](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-23TreeInsert.png)
...
![RBTREE](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-RBTREE.png)
...
![RBTREE-Insert](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-08-30-RBTREE-Insert.png)
