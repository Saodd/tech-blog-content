```json lw-blog-meta
{"Title":"Go源码：fmt标准库","Date":"2019-11-17","Brev":"前后半年时间把计算机基础课程好好地学了一遍，接下来该看源码了。第一个研读对象必须是Golang，这个凝聚了谷歌大佬思想精华的新语言，看完之后一定会受益匪浅。我们从标准库中最简单的一个 fmt 开始看。","Tags":["Golang","源码"]}
```
