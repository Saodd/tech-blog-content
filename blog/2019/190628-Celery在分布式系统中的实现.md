```json lw-blog-meta
{"title":"Celery练习：在多主机环境下的消息传递","date":"2019-06-28","brev":"用docker来模拟一个分布式系统的环境来学习Celery框架。","tags":["中间件"],"path":"blog/2019/190628-Celery在分布式系统中的实现.md"}
```
...
![Celery结构图](https://cdn.jsdelivr.net/gh/Saodd/tech-blog-pic@gh-pages/2019/2019-06-28-CeleryStruct.png)
