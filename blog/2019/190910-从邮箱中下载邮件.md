```json lw-blog-meta
{"title":"从邮箱中下载邮件（进阶版）","date":"2019-09-10","brev":"开发电子邮件解析工具时，有个很大的麻烦是下载问题。这里提供一个新的思路，将邮件下载下来，保存到本地的某个地方（Mongo）；然后从本地读出来，再进行解析。","tags":["Python"],"path":"blog/2019/190910-从邮箱中下载邮件.md"}
```
