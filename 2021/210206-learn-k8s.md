...
此后过了整整一年，在进一步熟悉 Docker 和 swarm 的基本操作，从[etcd](./210116-etcd-guide.md) 了解分布式和服务发现理论，从[caddy](./210127-caddy-gin-jwt.md) 和 [Envoy](./210129-learn-envoy.md) 了解网络代理，之后，我再次学习 [minikube](https://kubernetes.io/zh/docs/tutorials/) 我发现此时的我已经进入了一个新的境界，我开始真正地理解那些晦涩的概念。我想，我该进入下一个阶段了。
