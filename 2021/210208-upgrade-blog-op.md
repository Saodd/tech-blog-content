...
之前我在 [学习Caddy的文章](./210127-caddy-gin-jwt.md) 中有说过，说Caddy的配置文件非常好写，我今天实际（在尽可能接近生产环境配置的难度下）写了一下，觉得还是很难写，还是要像Nginx一样，这里抄抄那里抄抄。
...
安装过程在我 [之前的k8s的文章](./210206-learn-k8s.md) 中介绍过，不再赘述。不过这次在完全"正常"的网络环境下安装k8s，即使是这几天已经反复安装过几遍的我也踩了好久的坑……
