...
![Figure 39.1.1](../pic/2019/2019-09-02-Fig-39-1-1.png)

注意，每个文件描述符的偏离值都是单独计算的，不受其他任务的影响。看一下将一个文件打开两次会发生什么：

![Figure 39.1.2](../pic/2019/2019-09-02-Fig-39-1-2.png)

一个有趣的函数lseek()可以改变偏离值，而不实际发起IO请求：

![Figure 39.1.3](../pic/2019/2019-09-02-Fig-39-1-3.png)
...
![Figure 39.3](../pic/2019/2019-09-02-Fig-39-3.png)
